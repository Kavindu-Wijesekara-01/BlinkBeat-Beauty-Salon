  ...
  return (
    ...
    id='home'>
      ...
      <div className="relative z-20 min-h-screen flex items-center justify-center px-4 ">
        <div className="text-center text-white max-w-4xl mx-auto w-full">
          ...
          <div className="space-y-6 mb-8">
            ...
            {/* Animated Divider */}
            <div 
              className={`flex justify-center items-center gap-3 sm:gap-4 md:gap-6 transition-all duration-1000 delay-500 ${
      ...
      @keyframes particle-smooth {
        ...
        25% { 
          transform: translate(40px, -20px) scale(1.1) rotate(90deg);
          opacity: 0.6;
        }
        50% { 
          transform: translate(80px, 10px) scale(0.9) rotate(180deg);
          opacity: 0.3;
        }
        75% { 
      ...
      /* Desktop version of particle animation */
      @media (min-width: 768px) {
        @keyframes particle-smooth {
          ...
          25% { 
            transform: translate(80px, -40px) scale(1.2) rotate(90deg);
            opacity: 0.7;
          }
          50% { 
            transform: translate(160px, 20px) scale(0.8) rotate(180deg);
            opacity: 0.3;
          }
          75% { 
      ...
      .animate-particle-smooth {
        animation: particle-smooth var(--duration, 20s) cubic-bezier(0.4, 0, 0.2, 1) infinite;
      }
      `}</style>
    </div>
  );
