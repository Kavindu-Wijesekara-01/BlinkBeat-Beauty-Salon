...
const About = () => {
  ...
  return (
    <section id="about" className="relative overflow-hidden bg-linear-to-br from-pink-900 via-black to-pink-800 py-16 bg-white">

      {/* Moving Pink Orbs */}
        <div className="absolute top-20 left-10 w-96 h-96 bg-linear-to-r from-pink-600/20 to-rose-600/20 rounded-full blur-3xl animate-orb-float"></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-linear-to-r from-rose-500/15 to-pink-500/15 rounded-full blur-3xl animate-orb-float-reverse"></div>
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-linear-to-r from-pink-400/10 to-rose-400/10 rounded-full blur-3xl animate-orb-pulse"></div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">About Our Salon</h2>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute bg-linear-to-r from-pink-500 to-pink-700 p-3 -right-2 -bottom-7 flex flex-col items-center justify-center rounded-xl text-white"><span className='text-4xl font-bold'>
              11+
          ...
          <div className="lg:w-1/2">
            ...
            {/* CTA Button */}
            <button className="group relative bg-linear-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white md:px-6 px-8 py-3 rounded-md text-sm font-medium transition-all duration-300 transform hover:scale-105 md:w-auto sm:w-auto max-w-xs shadow-lg hover:shadow-pink-500/25">
